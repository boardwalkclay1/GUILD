...
const scenes = [

  {
    ...
    rumble: false,
    text: `
      <p>Life outside the door is not dramatic. It is not heroic. It is something far more suffocating — <strong>small</strong>.</p>
      ...
      <p>In this world of scarcity and shrinking horizons, there is one rumor that refuses to die. A rumor about a door. A door that does not belong here. A door that leads somewhere else — somewhere no one can describe, only fear.</p>
      ...
      <p>And yet… in the same breath, with the same trembling voice, they whisper something else: that behind that door, there might be a life of riches, wealth, and freedom so vast that no one out here even has the language to describe it.</p>
    `
  },

  {
    ...
    rumble: false,
    text: `
      <p>The door stands at the edge of our world like a wound in the stone. No signs. No guards. No instructions. Just a silent challenge.</p>
...

  {
    ...
    text: `
      ...
      <p>That beyond the screams, beyond the fire, beyond the Dragons — there is a place where the poor are no longer poor. Where the chains of this small life fall off. Where freedom is not a fantasy, but a landscape.</p>
...

  {
    ...
    text: `
      ...
      <p>That was nine years ago — the day I decided I would rather face the Dragons than live the rest of my life staring at a door I was too afraid to open.</p>
    `
  },

  {
    ...
    rumble: true,
    text: `
      <p>When I finally walked toward the door, no one walked with me.</p>
...

  {
    ...
    text: `
      ...
      <p>I stood in a vast Colosseum. Walls rising into darkness. Torches bending in a wind I couldn’t feel. Sand stained with old battles.</p>
      <p>And in the center of the Arena, it waited: a Dragon. Massive. Coiled. Eyes burning like coals.</p>
...

  {
    ...
    text: `
      ...
      <p>The Dragon did not care about my intentions. It answered my ambition with fire.</p>
...

  {
    ...
    rumble: true,
    text: `
      <p>The second time I faced the Dragon, I was not the same person.</p>
...

  {
    ...
    text: `
      ...
      <p>A second Dragon. Heavier. Hotter. More intelligent. More cruel.</p>
...

  {
    ...
    text: `
      ...
      <p>Since then, I have walked through that door more times than I can count. I have faced Dragons of every size and shape. Some I defeated. Some defeated me.</p>
...

  {
    ...
    rumble: false,
    text: `
      <p>Every Dragon has a purse.</p>
      <p>Not just of coin — but of power, perspective, and freedom.</p>
...

  {
    ...
    finale: true,
    text: `
      <p>I am the only one many have seen come back alive from that door.</p>
      <p>They look at my scars and think they are proof the door is cursed. They don’t understand: my scars are proof that I am forged.</p>
      <p>I still walk through the door because I know this: if the Dragons are real, then the riches are too. If the screams are real, then so is the freedom on the other side.</p>
...
nextBtn.addEventListener("click", () => {
  ...
  if (currentScene < scenes.length) {
    ...
    text.innerHTML = "<h2>The door is waiting.</h2>";
